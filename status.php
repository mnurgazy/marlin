...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="status_form.php" method="POST">
            <div class="row">
                <div class="col-xl-6">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="example-select" name="statusList">
                                                <?php foreach ($statusList as $status => $value) {
                                                    if ($user_data['status'] == $status) 
                                                        echo '<option value="'.$status.'" selected="selected">'.$value.'</option>';
